...
HD_PWD='D:/AIOT/vivado_pj/sram_test_board/sram_test_board.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sram_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sram_board.tcl -notrace
