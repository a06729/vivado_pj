...
HD_PWD='D:/AIOT/vivado_pj/sram_test_board/sram_test_board.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sram_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sram_board.tcl
