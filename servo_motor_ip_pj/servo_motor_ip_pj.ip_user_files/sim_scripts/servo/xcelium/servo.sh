...
#
# Script generated by Vivado on Thu Jun 11 16:25:06 +0900 2026
...
#
# Usage        : servo.sh
#                servo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                servo.sh [-reset_run]
#                servo.sh [-reset_log]
#                servo.sh [-help]
#
...
#                script (type 'servo.sh -help' for more information).
#
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./servo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../servo_motor_ip_pj.gen/sources_1/bd/servo/ipshared/30ef" +incdir+"$ref_dir/../../../../servo_motor_ip_pj.gen/sources_1/bd/servo/ipshared/ec67/hdl" +incdir+"../../../../servo_motor_ip_pj.gen/sources_1/bd/servo/ipshared/30ef" +incdir+"../../../../servo_motor_ip_pj.gen/sources_1/bd/servo/ipshared/ec67/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.servo xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.servo -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log servo_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./servo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: servo.sh [-help]\n\
Usage: servo.sh [-step]\n\
Usage: servo.sh [-lib_map_path]\n\
Usage: servo.sh [-reset_run]\n\
Usage: servo.sh [-reset_log]\n\
Usage: servo.sh [-keep_index]\n\
Usage: servo.sh [-noclean_files]\n\n\
