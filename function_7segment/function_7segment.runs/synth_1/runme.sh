...
HD_PWD='D:/AIOT/vivado_pj/function_7segment/function_7segment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fnd_function.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fnd_function.tcl
