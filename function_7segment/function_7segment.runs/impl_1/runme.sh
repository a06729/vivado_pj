...
HD_PWD='D:/AIOT/vivado_pj/function_7segment/function_7segment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fnd_function.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fnd_function.tcl -notrace
