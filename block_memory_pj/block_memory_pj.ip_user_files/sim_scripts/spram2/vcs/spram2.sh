...
#
# Script generated by Vivado on Wed Apr 29 14:03:03 +0900 2026
...
# script info
echo -e "spram2.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.spram2 xil_defaultlib.glbl -o spram2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./spram2_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key spram2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc spram2_simv.daidir vcs_lib c.obj)
