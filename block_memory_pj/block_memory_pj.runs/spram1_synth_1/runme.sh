...
HD_PWD='D:/AIOT/vivado_pj/block_memory_pj/block_memory_pj.runs/spram1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spram1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spram1.tcl
