...
-- Date        : Tue Jun  9 17:00:24 2026
-- Host        : SmST12 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ pwm_test_pwm_axi_v1_0_0_1_sim_netlist.vhdl
-- Design      : pwm_test_pwm_axi_v1_0_0_1
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clockdivider_pwm is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clockdivider_pwm;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clockdivider_pwm is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_top_pwm is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_top_pwm;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_top_pwm is
...
begin
  SR(0) <= \^sr\(0);
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_clockdivider_pwm
     port map (
...
U1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter
     port map (
      ...
      S(1) => U1_n_2,
      S(0) => U1_n_3,
      \count_reg[0]_0\ => U0_n_0,
      \count_reg[0]_1\ => \^sr\(0),
      o_pwm => o_pwm,
      o_pwm_0(0) => o_pwm_0(0),
      s00_pwm_axi_aresetn => s00_pwm_axi_aresetn
    );
U2: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_compare
     port map (
      CO(0) => U2_n_0,
      DI(3) => U1_n_5,
      DI(2) => U1_n_6,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwm_axi_v1_0_S00_pwm_AXI is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwm_axi_v1_0_S00_pwm_AXI;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwm_axi_v1_0_S00_pwm_AXI is
...
pwm: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_top_pwm
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwm_axi_v1_0 is
  port (
    o_dir : out STD_LOGIC_VECTOR ( 1 downto 0 );
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwm_axi_v1_0;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwm_axi_v1_0 is
begin
pwm_axi_v1_0_S00_pwm_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwm_axi_v1_0_S00_pwm_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "pwm_test_pwm_axi_v1_0_0_1,pwm_axi_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "pwm_axi_v1_0,Vivado 2023.1";
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwm_axi_v1_0
     port map (
