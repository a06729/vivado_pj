...
HD_PWD='C:/vivado_pj/vga_pj/vga_pj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tic_tac_toe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tic_tac_toe.tcl
