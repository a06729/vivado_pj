...
HD_PWD='C:/vivado_pj/vga_pj/vga_pj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tic_tac_toe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tic_tac_toe.tcl -notrace
