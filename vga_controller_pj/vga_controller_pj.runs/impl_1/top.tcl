namespace eval ::optrace {
  variable script "C:/vivado_pj/vga_controller_pj/vga_controller_pj.runs/impl_1/top.tcl"
...
OPTRACE "set parameters" START { }
  ...
  set_property ip_output_repo C:/vivado_pj/vga_controller_pj/vga_controller_pj.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES XPM_MEMORY [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/vivado_pj/vga_controller_pj/vga_controller_pj.runs/synth_1/top.dcp
  read_ip -quiet c:/vivado_pj/vga_controller_pj/vga_controller_pj.srcs/sources_1/ip/image_rom/image_rom.xci
OPTRACE "read constraints: implementation" START { }
  read_xdc C:/vivado_pj/vga_controller_pj/vga_controller_pj.srcs/constrs_1/new/vga_controller_xdc.xdc
