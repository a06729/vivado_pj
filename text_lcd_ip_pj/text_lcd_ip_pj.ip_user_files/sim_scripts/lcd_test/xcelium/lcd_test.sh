...
#
# Script generated by Vivado on Thu Jun 11 11:40:46 +0900 2026
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : lcd_test.sh
...
#
# Usage        : lcd_test.sh
#                lcd_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                lcd_test.sh [-reset_run]
#                lcd_test.sh [-reset_log]
#                lcd_test.sh [-help]
#
...
#                script (type 'lcd_test.sh -help' for more information).
#
...
# script info
echo -e "lcd_test.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./lcd_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.lcd_test xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.lcd_test -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log lcd_test_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./lcd_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: lcd_test.sh [-help]\n\
Usage: lcd_test.sh [-step]\n\
Usage: lcd_test.sh [-lib_map_path]\n\
Usage: lcd_test.sh [-reset_run]\n\
Usage: lcd_test.sh [-reset_log]\n\
Usage: lcd_test.sh [-keep_index]\n\
Usage: lcd_test.sh [-noclean_files]\n\n\
