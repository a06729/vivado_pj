...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" \
  ...
  vlogan -work xlconcat_v2_1_4 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mb1_block xil_defaultlib.glbl -o mb1_block_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mb1_block_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mb1_block_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mb1_block_simv.daidir vcs_lib c.obj)
