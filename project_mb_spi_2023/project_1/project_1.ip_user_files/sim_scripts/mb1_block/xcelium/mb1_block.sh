...
#
# Script generated by Vivado on Tue May 26 12:47:17 +0900 2026
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : mb1_block.sh
...
#
# Usage        : mb1_block.sh
#                mb1_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mb1_block.sh [-reset_run]
#                mb1_block.sh [-reset_log]
#                mb1_block.sh [-help]
#
...
#                script (type 'mb1_block.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname microblaze_v11_0_11 -libname xil_defaultlib -libname lmb_v10_v3_0_12 -libname lmb_bram_if_cntlr_v4_0_22 -libname blk_mem_gen_v8_4_6 -libname axi_lite_ipif_v3_0_4 -libname axi_intc_v4_1_17 -libname xlconcat_v2_1_4 -libname mdm_v3_2_24 -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_13 -libname lib_pkg_v1_0_2 -libname axi_timer_v2_0_30 -libname lib_srl_fifo_v1_0_2 -libname axi_uartlite_v2_0_32 -libname interrupt_control_v3_1_4 -libname axi_gpio_v2_0_30 -libname generic_baseblocks_v2_1_0 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_28 -libname fifo_generator_v13_2_8 -libname axi_data_fifo_v2_1_27 -libname axi_crossbar_v2_1_29 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm microblaze_v11_0_11 xil_defaultlib lmb_v10_v3_0_12 lmb_bram_if_cntlr_v4_0_22 blk_mem_gen_v8_4_6 axi_lite_ipif_v3_0_4 axi_intc_v4_1_17 xlconcat_v2_1_4 mdm_v3_2_24 lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 lib_pkg_v1_0_2 axi_timer_v2_0_30 lib_srl_fifo_v1_0_2 axi_uartlite_v2_0_32 interrupt_control_v3_1_4 axi_gpio_v2_0_30 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_28 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_crossbar_v2_1_29)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "mb1_block.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mb1_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" \
  ...
  xmvlog -work blk_mem_gen_v8_4_6 $xmvlog_opts +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" \
  ...
  xmvlog -work xlconcat_v2_1_4 $xmvlog_opts +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" \
  ...
  xmvlog -work generic_baseblocks_v2_1_0 $xmvlog_opts +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" \
  ...
  xmvlog -work axi_crossbar_v2_1_29 $xmvlog_opts +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"$ref_dir/../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/30ef" +incdir+"../../../../project_1.gen/sources_1/bd/mb1_block/ipshared/ec67/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mb1_block xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mb1_block -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mb1_block_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mb1_block.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mb1_block.sh [-help]\n\
Usage: mb1_block.sh [-step]\n\
Usage: mb1_block.sh [-lib_map_path]\n\
Usage: mb1_block.sh [-reset_run]\n\
Usage: mb1_block.sh [-reset_log]\n\
Usage: mb1_block.sh [-keep_index]\n\
Usage: mb1_block.sh [-noclean_files]\n\n\
