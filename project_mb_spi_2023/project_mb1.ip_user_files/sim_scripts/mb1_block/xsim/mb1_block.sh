...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L microblaze_v11_0_11 -L xil_defaultlib -L lmb_v10_v3_0_12 -L lmb_bram_if_cntlr_v4_0_22 -L blk_mem_gen_v8_4_6 -L axi_lite_ipif_v3_0_4 -L axi_intc_v4_1_17 -L xlconcat_v2_1_4 -L mdm_v3_2_24 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L lib_pkg_v1_0_2 -L axi_timer_v2_0_30 -L lib_srl_fifo_v1_0_2 -L axi_uartlite_v2_0_32 -L interrupt_control_v3_1_4 -L axi_gpio_v2_0_30 -L generic_baseblocks_v2_1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_28 -L fifo_generator_v13_2_8 -L axi_data_fifo_v2_1_27 -L axi_crossbar_v2_1_29 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mb1_block xil_defaultlib.mb1_block xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mb1_block -key {Behavioral:sim_1:Functional:mb1_block} -tclbatch cmd.tcl -protoinst "protoinst_files/mb1_block.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="G:/Xilinx/Vivado/2023.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mb1_block.wdb xsim.dir libdpi.so)
