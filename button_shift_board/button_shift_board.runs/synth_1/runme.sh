...
HD_PWD='D:/AIOT/vivado_pj/button_shift_board/button_shift_board.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log button_shift_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source button_shift_board.tcl
