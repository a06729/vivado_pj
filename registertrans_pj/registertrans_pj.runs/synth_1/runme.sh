...
HD_PWD='D:/AIOT/vivado_pj/registertrans_pj/registertrans_pj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log registertrans.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source registertrans.tcl
