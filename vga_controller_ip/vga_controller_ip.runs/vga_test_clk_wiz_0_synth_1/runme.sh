...
HD_PWD='C:/vivado_pj/vga_controller_ip/vga_controller_ip.runs/vga_test_clk_wiz_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_test_clk_wiz_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_test_clk_wiz_0.tcl
