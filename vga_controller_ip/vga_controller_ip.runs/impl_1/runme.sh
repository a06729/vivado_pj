...
HD_PWD='C:/vivado_pj/vga_controller_ip/vga_controller_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_test_wrapper.tcl -notrace
