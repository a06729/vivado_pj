...
#
# Script generated by Vivado on Wed May 13 11:46:49 +0900 2026
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo_16x8.sh
...
#
# Usage        : fifo_16x8.sh
#                fifo_16x8.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_16x8.sh [-reset_run]
#                fifo_16x8.sh [-reset_log]
#                fifo_16x8.sh [-help]
#
...
#                script (type 'fifo_16x8.sh -help' for more information).
#
...
design_libs_elab="-libname fifo_generator_v13_2_9 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver fifo_generator_v13_2_9 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "fifo_16x8.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_16x8.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fifo_16x8 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fifo_16x8 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fifo_16x8_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_16x8.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_16x8.sh [-help]\n\
Usage: fifo_16x8.sh [-step]\n\
Usage: fifo_16x8.sh [-lib_map_path]\n\
Usage: fifo_16x8.sh [-reset_run]\n\
Usage: fifo_16x8.sh [-reset_log]\n\
Usage: fifo_16x8.sh [-keep_index]\n\
Usage: fifo_16x8.sh [-noclean_files]\n\n\
