...
design_libs=(fifo_generator_v13_2_9 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fifo_16x8 xil_defaultlib.glbl -o fifo_16x8_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fifo_16x8_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fifo_16x8_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fifo_16x8_simv.daidir vcs_lib c.obj)
