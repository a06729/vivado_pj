...
#
# Script generated by Vivado on Thu Jun 04 16:03:14 +0900 2026
...
#
# Usage        : axi_fnd.sh
#                axi_fnd.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_fnd.sh [-reset_run]
#                axi_fnd.sh [-reset_log]
#                axi_fnd.sh [-help]
#
...
#                script (type 'axi_fnd.sh -help' for more information).
#
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_fnd.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" \
  ...
  xmvlog -work blk_mem_gen_v8_4_6 $xmvlog_opts +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" \
  ...
  xmvlog -work generic_baseblocks_v2_1_0 $xmvlog_opts +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" \
  "../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/b752/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" \
  "../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_28 $xmvlog_opts +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" \
  "../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/87d1/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_8 $xmvlog_opts +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" \
  ...
  xmvlog -work axi_data_fifo_v2_1_27 $xmvlog_opts +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" \
  "../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/fab7/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_29 $xmvlog_opts +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_fnd xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_fnd -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_fnd_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_fnd.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_fnd.sh [-help]\n\
Usage: axi_fnd.sh [-step]\n\
Usage: axi_fnd.sh [-lib_map_path]\n\
Usage: axi_fnd.sh [-reset_run]\n\
Usage: axi_fnd.sh [-reset_log]\n\
Usage: axi_fnd.sh [-keep_index]\n\
Usage: axi_fnd.sh [-noclean_files]\n\n\
