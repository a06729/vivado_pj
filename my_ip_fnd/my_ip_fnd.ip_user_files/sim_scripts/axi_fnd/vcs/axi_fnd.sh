...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" \
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" \
  ...
  vlogan -work generic_baseblocks_v2_1_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" \
  ...
  vlogan -work fifo_generator_v13_2_8 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" \
  ...
  vlogan -work axi_data_fifo_v2_1_27 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" \
  "../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/fab7/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_crossbar_v2_1_29 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"$ref_dir/../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/30ef" +incdir+"../../../../my_ip_fnd.gen/sources_1/bd/axi_fnd/ipshared/ec67/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_fnd xil_defaultlib.glbl -o axi_fnd_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_fnd_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_fnd_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_fnd_simv.daidir vcs_lib c.obj)
