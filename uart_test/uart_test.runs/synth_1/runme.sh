...
HD_PWD='C:/vivado_pj/uart_test/uart_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_echo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_echo.tcl
