...
HD_PWD='C:/vivado_pj/uart_test/uart_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_echo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_echo.tcl -notrace
