...
module m00_couplers_imp_1745GJ1
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m01_couplers_imp_JORYI0
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module microblaze_0_local_memory_imp_W13633
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > spi microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  spi_dlmb_bram_if_cntlr_2 dlmb_bram_if_cntlr
  ...
  spi_dlmb_v10_2 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  spi_ilmb_bram_if_cntlr_2 ilmb_bram_if_cntlr
...
module s00_couplers_imp_DZWH5J
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
...
(* CORE_GENERATION_INFO = "spi,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=spi,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=17,numReposBlks=12,numNonXlnxBlks=0,numHierBlks=5,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=16,da_board_cnt=42,da_clkrst_cnt=4,da_mb_cnt=3,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "spi.hwdef" *) 
module spi
   (reset,
    spi_io0_i,
    spi_io0_o,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN spi_sys_clock, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clock;
  ...
  spi_axi_quad_spi_0_2 axi_quad_spi_0
  ...
  spi_axi_uartlite_0_1 axi_uartlite_0
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > spi microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  spi_microblaze_0_2 microblaze_0
  ...
  spi_microblaze_0_axi_periph_6 microblaze_0_axi_periph
  ...
  microblaze_0_local_memory_imp_W13633 microblaze_0_local_memory
  ...
  spi_rst_clk_wiz_1_100M_2 rst_clk_wiz_1_100M
       (.aux_reset_in(1'b1),
...
module spi_microblaze_0_axi_periph_6
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  m00_couplers_imp_1745GJ1 m00_couplers
  ...
  m01_couplers_imp_JORYI0 m01_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
  ...
  s00_couplers_imp_DZWH5J s00_couplers
       (.M_ACLK(microblaze_0_axi_periph_ACLK_net),
        .M_ARESETN(microblaze_0_axi_periph_ARESETN_net),
