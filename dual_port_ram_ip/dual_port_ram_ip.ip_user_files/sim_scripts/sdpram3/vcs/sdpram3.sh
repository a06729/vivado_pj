...
#
# Script generated by Vivado on Wed Apr 29 15:23:32 +0900 2026
...
# script info
echo -e "sdpram3.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.sdpram3 xil_defaultlib.glbl -o sdpram3_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./sdpram3_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key sdpram3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc sdpram3_simv.daidir vcs_lib c.obj)
