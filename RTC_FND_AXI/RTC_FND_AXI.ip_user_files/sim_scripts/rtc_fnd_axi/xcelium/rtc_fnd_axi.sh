...
#
# Script generated by Vivado on Tue Jun 09 12:43:49 +0900 2026
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : rtc_fnd_axi.sh
...
#
# Usage        : rtc_fnd_axi.sh
#                rtc_fnd_axi.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                rtc_fnd_axi.sh [-reset_run]
#                rtc_fnd_axi.sh [-reset_log]
#                rtc_fnd_axi.sh [-help]
#
...
#                script (type 'rtc_fnd_axi.sh -help' for more information).
#
...
# script info
echo -e "rtc_fnd_axi.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./rtc_fnd_axi.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../RTC_FND_AXI.gen/sources_1/bd/rtc_fnd_axi/ipshared/30ef" +incdir+"$ref_dir/../../../../RTC_FND_AXI.gen/sources_1/bd/rtc_fnd_axi/ipshared/ec67/hdl" +incdir+"../../../../RTC_FND_AXI.gen/sources_1/bd/rtc_fnd_axi/ipshared/30ef" +incdir+"../../../../RTC_FND_AXI.gen/sources_1/bd/rtc_fnd_axi/ipshared/ec67/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.rtc_fnd_axi xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.rtc_fnd_axi -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log rtc_fnd_axi_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./rtc_fnd_axi.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: rtc_fnd_axi.sh [-help]\n\
Usage: rtc_fnd_axi.sh [-step]\n\
Usage: rtc_fnd_axi.sh [-lib_map_path]\n\
Usage: rtc_fnd_axi.sh [-reset_run]\n\
Usage: rtc_fnd_axi.sh [-reset_log]\n\
Usage: rtc_fnd_axi.sh [-keep_index]\n\
Usage: rtc_fnd_axi.sh [-noclean_files]\n\n\
