...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.rtc_fnd_axi xil_defaultlib.glbl -o rtc_fnd_axi_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./rtc_fnd_axi_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key rtc_fnd_axi_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc rtc_fnd_axi_simv.daidir vcs_lib c.obj)
