...
vlog -work xpm  -incr -mfcu  -sv "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/ec67/hdl" "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/30ef" \
...
vlog -work blk_mem_gen_v8_4_6  -incr -mfcu  "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/ec67/hdl" "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/30ef" \
"../../../../userMap.gen/sources_1/bd/system/ipshared/bb55/simulation/blk_mem_gen_v8_4.v" \

vlog -work xil_defaultlib  -incr -mfcu  "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/ec67/hdl" "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/30ef" \
"../../../bd/system/ip/system_lmb_bram_0/sim/system_lmb_bram_0.v" \

vlog -work generic_baseblocks_v2_1_0  -incr -mfcu  "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/ec67/hdl" "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/30ef" \
"../../../../userMap.gen/sources_1/bd/system/ipshared/b752/hdl/generic_baseblocks_v2_1_vl_rfs.v" \

vlog -work axi_infrastructure_v1_1_0  -incr -mfcu  "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/ec67/hdl" "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/30ef" \
"../../../../userMap.gen/sources_1/bd/system/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \

vlog -work axi_register_slice_v2_1_28  -incr -mfcu  "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/ec67/hdl" "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/30ef" \
"../../../../userMap.gen/sources_1/bd/system/ipshared/87d1/hdl/axi_register_slice_v2_1_vl_rfs.v" \

vlog -work fifo_generator_v13_2_8  -incr -mfcu  "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/ec67/hdl" "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/30ef" \
...
vlog -work axi_data_fifo_v2_1_27  -incr -mfcu  "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/ec67/hdl" "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/30ef" \
"../../../../userMap.gen/sources_1/bd/system/ipshared/fab7/hdl/axi_data_fifo_v2_1_vl_rfs.v" \

vlog -work axi_crossbar_v2_1_29  -incr -mfcu  "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/ec67/hdl" "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/30ef" \
"../../../../userMap.gen/sources_1/bd/system/ipshared/f8f3/hdl/axi_crossbar_v2_1_vl_rfs.v" \

vlog -work xil_defaultlib  -incr -mfcu  "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/ec67/hdl" "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/30ef" \
"../../../bd/system/ip/system_xbar_0/sim/system_xbar_0.v" \

vlog -work axi_protocol_converter_v2_1_28  -incr -mfcu  "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/ec67/hdl" "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/30ef" \
...
vlog -work xlconcat_v2_1_4  -incr -mfcu  "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/ec67/hdl" "+incdir+../../../../userMap.gen/sources_1/bd/system/ipshared/30ef" \
