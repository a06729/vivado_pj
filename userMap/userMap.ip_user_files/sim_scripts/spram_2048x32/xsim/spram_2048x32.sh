...
#
# Script generated by Vivado on Wed Jun 03 23:40:03 +0900 2026
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : spram_2048x32.sh
...
#
# Usage        : spram_2048x32.sh
#                spram_2048x32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                spram_2048x32.sh [-reset_run]
#                spram_2048x32.sh [-reset_log]
#                spram_2048x32.sh [-help]
#
...
# script info
echo -e "spram_2048x32.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./spram_2048x32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot spram_2048x32 xil_defaultlib.spram_2048x32 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim spram_2048x32 -key {Behavioral:sim_1:Functional:spram_2048x32} -tclbatch cmd.tcl -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb spram_2048x32.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./spram_2048x32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: spram_2048x32.sh [-help]\n\
Usage: spram_2048x32.sh [-step]\n\
Usage: spram_2048x32.sh [-lib_map_path]\n\
Usage: spram_2048x32.sh [-reset_run]\n\
Usage: spram_2048x32.sh [-reset_log]\n\
Usage: spram_2048x32.sh [-keep_index]\n\
Usage: spram_2048x32.sh [-noclean_files]\n\n\
