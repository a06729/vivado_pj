...
-- Command     : write_vhdl -force -mode funcsim -rename_top top_fndcontrol2_0 -prefix
--               top_fndcontrol2_0_ top_fndcontrol2_0_sim_netlist.vhdl
...
entity top_fndcontrol2_0_btn_in is
  port (
...
end top_fndcontrol2_0_btn_in;

architecture STRUCTURE of top_fndcontrol2_0_btn_in is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity top_fndcontrol2_0_btn_in_0 is
  port (
  ...
  attribute ORIG_REF_NAME of top_fndcontrol2_0_btn_in_0 : entity is "btn_in";
end top_fndcontrol2_0_btn_in_0;

architecture STRUCTURE of top_fndcontrol2_0_btn_in_0 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity top_fndcontrol2_0_btn_in_1 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of top_fndcontrol2_0_btn_in_1 : entity is "btn_in";
end top_fndcontrol2_0_btn_in_1;

architecture STRUCTURE of top_fndcontrol2_0_btn_in_1 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity top_fndcontrol2_0_btn_in_2 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of top_fndcontrol2_0_btn_in_2 : entity is "btn_in";
end top_fndcontrol2_0_btn_in_2;

architecture STRUCTURE of top_fndcontrol2_0_btn_in_2 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity top_fndcontrol2_0_clockdivder is
  port (
    CLK : out STD_LOGIC;
    \^clk\ : in STD_LOGIC;
    reset : in STD_LOGIC;
...
end top_fndcontrol2_0_clockdivder;

architecture STRUCTURE of top_fndcontrol2_0_clockdivder is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity top_fndcontrol2_0_counter is
  port (
...
end top_fndcontrol2_0_counter;

architecture STRUCTURE of top_fndcontrol2_0_counter is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity top_fndcontrol2_0_spi_master is
  port (
...
end top_fndcontrol2_0_spi_master;

architecture STRUCTURE of top_fndcontrol2_0_spi_master is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity top_fndcontrol2_0_spi_slave is
  port (
...
end top_fndcontrol2_0_spi_slave;

architecture STRUCTURE of top_fndcontrol2_0_spi_slave is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity top_fndcontrol2_0_spi_task is
  port (
    reset_0 : out STD_LOGIC;
...
end top_fndcontrol2_0_spi_task;

architecture STRUCTURE of top_fndcontrol2_0_spi_task is
...
btn_in_u1: entity work.top_fndcontrol2_0_btn_in
     port map (
      btn(0) => btn(0),
      btn2_0 => btn2_0,
      btn2_reg_0 => \^reset_0\,
...
btn_in_u2: entity work.top_fndcontrol2_0_btn_in_0
     port map (
      btn(0) => btn(1),
      btn2_1 => btn2_1,
      btn2_reg_0 => \^reset_0\,
...
btn_in_u3: entity work.top_fndcontrol2_0_btn_in_1
     port map (
      btn(0) => btn(2),
      btn2_0 => btn2_0,
      btn2_1 => btn2_1,
...
btn_in_u4: entity work.top_fndcontrol2_0_btn_in_2
     port map (
      btn(0) => btn(3),
      btn2_3 => btn2_3,
      btn2_reg_0 => \^reset_0\,
...
spi_master_u1: entity work.top_fndcontrol2_0_spi_master
     port map (
...
spi_slave_u1: entity work.top_fndcontrol2_0_spi_slave
     port map (
      clk => clk,
      miso => miso,
      mosi => mosi,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity top_fndcontrol2_0_top_fndcontrol2 is
  port (
    fnd : out STD_LOGIC_VECTOR ( 6 downto 0 );
    led_out : out STD_LOGIC_VECTOR ( 7 downto 0 );
    fndsel : out STD_LOGIC_VECTOR ( 3 downto 0 );
...
end top_fndcontrol2_0_top_fndcontrol2;

architecture STRUCTURE of top_fndcontrol2_0_top_fndcontrol2 is
  signal U0_n_0 : STD_LOGIC;
  signal clk1000Hz : STD_LOGIC;
  signal s : STD_LOGIC_VECTOR ( 1 downto 0 );
begin
U0: entity work.top_fndcontrol2_0_spi_task
     port map (
...
U1: entity work.top_fndcontrol2_0_counter
     port map (
      CLK => clk1000Hz,
      Q(1 downto 0) => s(1 downto 0),
...
U2: entity work.top_fndcontrol2_0_clockdivder
     port map (
      CLK => clk1000Hz,
      \^clk\ => clk,
      \cnt_reg[0]_0\ => U0_n_0,
...
entity top_fndcontrol2_0 is
  ...
  attribute NotValidForBitStream of top_fndcontrol2_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of top_fndcontrol2_0 : entity is "top_fndcontrol2_0,top_fndcontrol2,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of top_fndcontrol2_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of top_fndcontrol2_0 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of top_fndcontrol2_0 : entity is "top_fndcontrol2,Vivado 2023.2";
end top_fndcontrol2_0;

architecture STRUCTURE of top_fndcontrol2_0 is
...
begin
inst: entity work.top_fndcontrol2_0_top_fndcontrol2
     port map (
      btn(3 downto 0) => btn(3 downto 0),
      clk => clk,
      fnd(6 downto 0) => fnd(6 downto 0),
