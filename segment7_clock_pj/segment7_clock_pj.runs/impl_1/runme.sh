...
HD_PWD='D:/AIOT/vivado_pj/segment7_clock_pj/segment7_clock_pj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log segment7_clock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source segment7_clock.tcl -notrace
