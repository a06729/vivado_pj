...
HD_PWD='D:/AIOT/vivado_pj/segment7_clock_pj/segment7_clock_pj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log segment7_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source segment7_clock.tcl
