...
HD_PWD='D:/AIOT/vivado_pj/byte_to_bcd/byte_to_bcd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log byte_to_bcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source byte_to_bcd.tcl
