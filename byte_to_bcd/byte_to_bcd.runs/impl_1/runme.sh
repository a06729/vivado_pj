...
HD_PWD='D:/AIOT/vivado_pj/byte_to_bcd/byte_to_bcd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log byte_to_bcd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source byte_to_bcd.tcl -notrace
