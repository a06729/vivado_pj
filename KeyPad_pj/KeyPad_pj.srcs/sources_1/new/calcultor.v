        ...
        if ((key_pressed_flag == 1'b1) && (digit0 != key_value)) begin
            ...
            if (countbit == 4'b0000) begin
                if (key_value < 4'd10) begin
                    A <= key_value;
                    digit0 <= key_value; digit1 <= 0; digit2 <= 0; digit3 <= key_value;
                    countbit <= 4'b0001;
                end else begin
                    A <= 0; B <= 0; C <= 0;
                    digit0 <= key_value; digit1 <= 0; digit2 <= 0; digit3 <= 0;
                    countbit <= 4'b0000;
                end
            end

            // countbit 0001 : 연산자 B 입력
            else if (countbit == 4'b0001) begin
                if ((key_value > 4'd9) && (key_value < 4'he)) begin
                    B <= key_value;
                    digit0 <= key_value; digit2 <= key_value;
                    countbit <= 4'b0010;
                end else begin
                    A <= 0; B <= 0; C <= 0;
                    digit0 <= key_value; digit1 <= 0; digit2 <= 0; digit3 <= 0;
            ...
            // countbit 0010 : C 입력
                ...
                if (key_value < 4'd10) begin
                    C <= key_value;
                    digit0 <= key_value; digit1 <= key_value;
                    countbit <= 4'b0100;
                end else begin
                    A <= 0; B <= 0; C <= 0;
                    digit0 <= key_value; digit1 <= 0; digit2 <= 0; digit3 <= 0;
            ...
            if (key_value == 4'he) begin
                A <= 0; B <= 0; C <= 0;
                digit0 <= 4'he; digit1 <= 0; digit2 <= 0; digit3 <= 0;
                countbit <= 4'b0000;
            end
