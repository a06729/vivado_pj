...
design_libs=(xpm xil_defaultlib microblaze_v11_0_11 axi_lite_ipif_v3_0_4 lib_pkg_v1_0_2 lib_srl_fifo_v1_0_2 lib_cdc_v1_0_2 axi_uartlite_v2_0_32 interrupt_control_v3_1_4 axi_gpio_v2_0_30 lmb_v10_v3_0_12 lmb_bram_if_cntlr_v4_0_22 blk_mem_gen_v8_4_6 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_28 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_crossbar_v2_1_29 axi_intc_v4_1_17 xlconcat_v2_1_4 mdm_v3_2_24 proc_sys_reset_v5_0_13)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pwm_test xil_defaultlib.glbl -o pwm_test_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pwm_test_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key pwm_test_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pwm_test_simv.daidir vcs_lib c.obj)
